...
impl ::protobuf::Message for DataflowMeta {
    ...
    fn merge_from(&mut self, is: &mut ::protobuf::CodedInputStream<'_>) -> ::protobuf::Result<()> {
        while let Some(tag) = is.read_raw_tag_or_eof()? {
            match tag {
                8 => {
                    self.center = is.read_uint64()?;
                },
                18 => {
                    is.read_repeated_packed_uint64_into(&mut self.neighbors)?;
                },
                16 => {
                    self.neighbors.push(is.read_uint64()?);
                },
                tag => {
    ...
    fn compute_size(&self) -> u64 {
        let mut my_size = 0;
        if self.center != 0 {
            my_size += ::protobuf::rt::uint64_size(1, self.center);
        }
...
impl ::protobuf::Message for OperatorInfo {
    ...
    fn compute_size(&self) -> u64 {
        ...
        if !self.header_id.is_empty() {
            my_size += ::protobuf::rt::string_size(3, &self.header_id);
        }
    ...
    fn write_to_with_cached_sizes(&self, os: &mut ::protobuf::CodedOutputStream<'_>) -> ::protobuf::Result<()> {
        ...
        if !self.header_id.is_empty() {
            os.write_string(3, &self.header_id)?;
        }
...
impl ::protobuf::Message for QueryEngineOptions {
    ...
    fn merge_from(&mut self, is: &mut ::protobuf::CodedInputStream<'_>) -> ::protobuf::Result<()> {
        while let Some(tag) = is.read_raw_tag_or_eof()? {
            match tag {
                ...
                16 => {
                    self.batch_size = is.read_uint64()?;
                },
                tag => {
                    ::protobuf::rt::read_unknown_or_skip_group(tag, is, self.special_fields.mut_unknown_fields())?;
                },
    ...
    fn compute_size(&self) -> u64 {
        let mut my_size = 0;
        if self.interval != 0 {
            my_size += ::protobuf::rt::uint64_size(1, self.interval);
        }
        if self.batch_size != 0 {
            my_size += ::protobuf::rt::uint64_size(2, self.batch_size);
        }
        my_size += ::protobuf::rt::unknown_fields_size(self.special_fields.unknown_fields());
        self.special_fields.cached_size().set(my_size as u32);
        my_size
    ...
    fn write_to_with_cached_sizes(&self, os: &mut ::protobuf::CodedOutputStream<'_>) -> ::protobuf::Result<()> {
        if self.interval != 0 {
            os.write_uint64(1, self.interval)?;
        }
        if self.batch_size != 0 {
...
pub struct Dataflow {
    ...
    pub nodes: ::std::collections::HashMap<u64, OperatorInfo>,
    // special fields
...
static file_descriptor_proto_data: &'static [u8] = b"\
    ...
    \x0cDataflowMeta\x12\x16\n\x06center\x18\x01\x20\x01(\x04R\x06center\x12\
    \x1c\n\tneighbors\x18\x02\x20\x03(\x04R\tneighbors\"\xca\x01\n\x0cOperat\
    orInfo\x12(\n\x04type\x18\x01\x20\x01(\x0e2\x14.common.OperatorTypeR\x04\
    type\x12\x19\n\x08table_id\x18\x02\x20\x01(\tR\x07tableId\x12\x1b\n\thea\
    der_id\x18\x03\x20\x01(\tR\x08headerId\x12'\n\x06values\x18\x04\x20\x03(\
    ...
    \x04R\x06nodeId\"\xa7\x01\n\tConnector\x12-\n\x04type\x18\x01\x20\x01(\
    \x0e2\x19.common.ConnectorTypeEnumR\x04type\x12@\n\x0fconnector_basic\
    \x18\x02\x20\x01(\x0b2\x17.common.ConnectionBasicR\x0econnectorBasic\x12\
    ...
    \x12\x1a\n\x08interval\x18\x01\x20\x01(\x04R\x08interval\x12\x1d\n\nbatc\
    h_size\x18\x02\x20\x01(\x04R\tbatchSize\"\xdd\x01\n\x08Dataflow\x12$\n\
    ...
    \x03\t\x08\x14\n\x1d\n\x04\x04\0\x02\0\x12\x03\n\x02\x14\"\x10\x20center\
    \x20node\x20id\n\n\x0c\n\x05\x04\0\x02\0\x05\x12\x03\n\x02\x08\n\x0c\n\
    \x05\x04\0\x02\0\x01\x12\x03\n\t\x0f\n\x0c\n\x05\x04\0\x02\0\x03\x12\x03\
    \n\x12\x13\n!\n\x04\x04\0\x02\x01\x12\x03\x0b\x02\x20\"\x14\x20center's\
    ...
    E\n\x02\x04\x01\x12\x04\x11\0\x17\x01\x1a9*\nOperatorInfo,\x20stores\x20\
    detail\x20information\x20of\x20an\x20operator\n\n\n\n\x03\x04\x01\x01\
    \x12\x03\x11\x08\x14\n\x13\n\x04\x04\x01\x02\0\x12\x03\x12\x02\x18\"\x06\
    \x20type\n\n\x0c\n\x05\x04\x01\x02\0\x06\x12\x03\x12\x02\x0e\n\x0c\n\x05\
    \x04\x01\x02\0\x01\x12\x03\x12\x0f\x13\n\x0c\n\x05\x04\x01\x02\0\x03\x12\
    \x03\x12\x16\x17\n*\n\x04\x04\x01\x02\x01\x12\x03\x13\x02\x16\"\x1d\x20o\
    nly\x20for\x20Reference\x20Operator\n\n\x0c\n\x05\x04\x01\x02\x01\x05\
    \x12\x03\x13\x02\x08\n\x0c\n\x05\x04\x01\x02\x01\x01\x12\x03\x13\t\x11\n\
    \x0c\n\x05\x04\x01\x02\x01\x03\x12\x03\x13\x14\x15\n*\n\x04\x04\x01\x02\
    \x02\x12\x03\x14\x02\x17\"\x1d\x20only\x20for\x20Reference\x20Operator\n\
    \n\x0c\n\x05\x04\x01\x02\x02\x05\x12\x03\x14\x02\x08\n\x0c\n\x05\x04\x01\
    \x02\x02\x01\x12\x03\x14\t\x12\n\x0c\n\x05\x04\x01\x02\x02\x03\x12\x03\
    \x14\x15\x16\n\x1b\n\x04\x04\x01\x02\x03\x12\x03\x15\x02\x1e\"\x0e\x20co\
    nsts\x20value\n\n\x0c\n\x05\x04\x01\x02\x03\x04\x12\x03\x15\x02\n\n\x0c\
    \n\x05\x04\x01\x02\x03\x06\x12\x03\x15\x0b\x12\n\x0c\n\x05\x04\x01\x02\
    \x03\x01\x12\x03\x15\x13\x19\n\x0c\n\x05\x04\x01\x02\x03\x03\x12\x03\x15\
    \x1c\x1d\n<\n\x04\x04\x01\x02\x04\x12\x03\x16\x02\x1a\"/\x20connector\
    \x20config,\x20only\x20for\x20Connector\x20Operator\n\n\x0c\n\x05\x04\
    \x01\x02\x04\x06\x12\x03\x16\x02\x0b\n\x0c\n\x05\x04\x01\x02\x04\x01\x12\
    \x03\x16\x0c\x15\n\x0c\n\x05\x04\x01\x02\x04\x03\x12\x03\x16\x18\x19\n\
    \x20\n\x02\x04\x02\x12\x04\x1c\0\x1f\x01\x1a\x14*\nConstant\x20operator\
    \n\n\n\n\x03\x04\x02\x01\x12\x03\x1c\x08\x0f\nE\n\x04\x04\x02\x02\0\x12\
    \x03\x1d\x02\x12\"8\x20value\x20of\x20constant,\x20format:\x20[<flag\x20\
    byte>,\x20<data\x20bytes>]\n\n\x0c\n\x05\x04\x02\x02\0\x05\x12\x03\x1d\
    \x02\x07\n\x0c\n\x05\x04\x02\x02\0\x01\x12\x03\x1d\x08\r\n\x0c\n\x05\x04\
    \x02\x02\0\x03\x12\x03\x1d\x10\x11\n\x16\n\x04\x04\x02\x02\x01\x12\x03\
    \x1e\x02\x15\"\t\x20node\x20id\n\n\x0c\n\x05\x04\x02\x02\x01\x05\x12\x03\
    ...
    \x04\x03\x02\x01\x06\x12\x03$\x02\x11\n\x0c\n\x05\x04\x03\x02\x01\x01\
    \x12\x03$\x12!\n\x0c\n\x05\x04\x03\x02\x01\x03\x12\x03$$%\n\x0b\n\x04\
    \x04\x03\x02\x02\x12\x03%\x02\x16\n\x0c\n\x05\x04\x03\x02\x02\x06\x12\
    \x03%\x02\t\n\x0c\n\x05\x04\x03\x02\x02\x01\x12\x03%\n\x11\n\x0c\n\x05\
    \x04\x03\x02\x02\x03\x12\x03%\x14\x15\n\n\n\x02\x05\0\x12\x04(\0+\x01\n\
